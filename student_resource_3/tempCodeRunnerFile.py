...
from src.utils import download_images  # Assuming you have this function for downloading images
from student_resource_3.src.constants import ALLOWED_UNITS, entity_unit_map  # Import constants
...
def predictor(model, img_url, entity_name):
    try:
        ...
        # For demonstration, let's use a placeholder unit (you should determine the actual unit in practice)
        unit = 'unit'  # Replace with logic to choose the appropriate unit from allowed_units
